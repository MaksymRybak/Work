$(function () {
    ...
    function buttonClicked(event, closeDialog) {
        ...
        if (event.action === 'company.dialog.insert.info.yes') {    // TODO: test
            sendInfoMessageToRoom();
        }
        closeDialog(true);
    }
    ...
    function sendInfoMessageToRoom() {
    ...
    AP.register({
        ...
        "info.message": receiveParameters,
